...
const iconButtonVariants = cva(
  "inline-flex items-center justify-center rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-latte-lavender disabled:pointer-events-none disabled:opacity-60 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        base: "border-latte-surface2 bg-latte-base/80 text-latte-text hover:border-latte-lavender/60 hover:text-latte-lavender shadow-md backdrop-blur",
        lavender:
        ...
        lavenderStrong:
          "border-latte-lavender/50 bg-latte-lavender/15 text-latte-lavender hover:border-latte-lavender/70 hover:bg-latte-lavender/25 border-2 shadow-[0_0_0_1px_rgba(114,135,253,0.2)] backdrop-blur-xl transition-all duration-200 hover:shadow-[0_0_20px_rgba(114,135,253,0.4)]",
        dangerOutline:
